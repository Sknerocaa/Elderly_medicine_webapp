          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="space-y-3">
                ...
                <input 
                  type="number"
                  {...register("age", { required: "Please enter your age", min: 50 })}
                  className="w-full p-4 text-xl border-2 border-slate-300 rounded-xl focus:border-blue-600 focus:ring-4 focus:ring-blue-100 transition-all"
                  placeholder="Ex: 65"
                />
            ...
            <button 
              type="submit"
              className="w-full bg-blue-600 hover:bg-blue-700 text-white text-2xl font-bold py-6 rounded-xl shadow-lg hover:shadow-xl transform transition hover:-translate-y-1 mt-4"
            >
              Book Appointment
            </button>
